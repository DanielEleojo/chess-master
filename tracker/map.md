...
- Progress/data model tying modes together — the coach ladder (018) now reads drill-history, sync-state, and analysis; how puzzle (013) and sparring (014) results feed it as new rungs/evidence emerges as those modes get built (013 should also claim the blunder-cluster rung's destination from analysis).
